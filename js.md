...
11. Теговые шаблоны
12. Инструкции импорта и экспорта
13. Ключевое слово this
14. Классы
15. Ключевые слова extends и super
16. Функция async и оператор await
17. Truthy/Falsy
18. Анаморфизмы и катаморфизмы
19. Генераторы
20. Статические методы

# <a name='1'>Объявление переменных: var, const, let</a>
